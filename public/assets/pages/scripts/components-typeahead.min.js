var ComponentsTypeahead = function () {
    var e = function () {
        var e = new Bloodhound({
            ...
            local: [{num: "metronic"}, {num: "keenthemes"}, {num: "metronic theme"}, {num: "metronic template"}, {num: "keenthemes team"}]
        });
        ...
        var t = new Bloodhound({
            ...
            limit: 10,
            prefetch: {
                url: "../demo/typeahead_countries.json", filter: function (e) {
        ...
        }, {name: "nhl", displayKey: "team", source: i.ttAdapter(), templates: {header: "<h3>NHL Teams</h3>"}})
    }, t = function () {
        var e = new Bloodhound({
            datumTokenizer: function (e) {
                return Bloodhound.tokenizers.whitespace(e.num)
        ...
        var a = new Bloodhound({
            datumTokenizer: function (e) {
                return e.tokens
            }, queryTokenizer: Bloodhound.tokenizers.whitespace, remote: "../demo/typeahead_custom.php?query=%QUERY"
        });
        ...
        var n = new Bloodhound({
            ...
            datumTokenizer: function (e) {
                return Bloodhound.tokenizers.whitespace(e.team)
            }, queryTokenizer: Bloodhound.tokenizers.whitespace, limit: 3, prefetch: "../demo/typeahead_nhl.json"
        });
