                                ...
                                <div class="img_container">
                                    <a target="_blank" href="{{ url('house/'.str_slug($item->name).'-'.$item->id) }}">
                                        ...
                                        <div class="short_info">
                                            <i class="icon_set_1_icon-44"></i>{{ $item->type_text }}<span class="price">{{ $item->price_text }}
                                                <sup>VNĐ</sup></span>
                                        </div>
                                    </a>
                                </div>
                                <div class="tour_title">
                                    ...
                                    <div class="wishlist">
                                        <a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);"
                                           onclick="addWishlist('{{ $item->id }}')">+<span
                                                    class="tooltip-content-flip"><span class="tooltip-back">Thêm vào yêu thích</span></span></a>
                                    </div><!-- End wish list-->
                                    <div style="margin-top: 20px" onclick="onHtmlClick('Historic', '{{ $cnt }}')"
                                         class="view_on_map">Xem trên bản đồ
                                    </div>
                                </div>
                            </div><!-- End box tour -->
                        </div><!-- End col-md-6 -->
