...
@section('content')
    ...
    @endif
    <h3 class="inline">Quản lý phản hồi từ khách hàng</h3>
                    ...
                    <form role="form" class="form-horizontal" id="form-testimonial">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Người dùng</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Điền tên" name="user">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Nội dung</label>
                                <div class="col-md-9">
                                    <textarea type="text" class="form-control" placeholder="Điền nội dung" name="content"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Địa chỉ</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Điền địa chỉ" name="address">
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    $(document).on('click', '#btn-save', function(e) {
        ...
        $.ajax({
            url: '{{ url('admin/settings/testimonial/store') }}',
            data: data,
            type: 'post',
            dataType: 'json',
    ...
    $(function () {
        table = $('#orders-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! url('admin/settings/testimonial.data') !!}',
            },
            columns: [
                {data: 'user', name: 'user'},
                    ...
                    <form role="form" class="form-horizontal" id="form-testimonial">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea type="text" class="form-control" placeholder="Điền nội dung" name="rate"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
