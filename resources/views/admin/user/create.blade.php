                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="type">
                                                                    ...
                                                                    <option value="{{ \App\Models\User::ADMIN }}"> Quản
                                                                        trị viên
                                                                    </option>
                                                                    <option value="{{ \App\Models\User::AGENT }}"> Môi
                                                                        giới viên
                                                                    </option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="status">
                                                                    ...
                                                                    <option value="">Vui lòng chọn</option>
                                                                    <option value="{{ \App\Models\User::ACTIVE }}"> Kích
                                                                        hoạt
                                                                    </option>
                                                                    <option value="{{ \App\Models\User::IN_ACTIVE }}">
                                                                        Không kích hoạt
                                                                    </option>
