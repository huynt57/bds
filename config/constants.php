...
return [
    ...
    'PROVINCE' => 3,
    'route_menu' => [
        'Các môi giới viên' => url('agents'),
        'Các BĐS theo tỉnh / thành phố' => url('regions'),
        'Các BĐS tại Bắc Ninh' => url('map?city_id=27'),
        'Các dự án đang phân phối / mở bán' => url('map-project?type='.\App\Models\Project::SALING),
