...
Route::group( [ 'prefix' => 'admin' ], function () {
	...
	Route::group( [ 'prefix' => 'user' ], function () {
		...
		Route::get( 'partner.data', [
			'as'   => 'user.data',
			'uses' => 'Backend\UserController@getPartnerByAttribute'
		] );
	} );
	...
	Route::group( [ 'prefix' => 'settings' ], function () {
		...
		Route::get( 'bank.data', [
			'as'   => 'bank.data',
			'uses' => 'Backend\SettingController@listBanksByAttribute'
		] );
	} );
